...
#define avioDhub_h (){}
    ...
    #define        avioDhubChMap_vpp_DINT0_R_Z1                             0x3
    #define        avioDhubChMap_vpp_DINT1_R_Z1                             0x4
    #define        avioDhubChMap_vpp_DINT_W_Z1                              0x5
    #define        avioDhubChMap_vpp_BCM_R_Z1                               0x6
    #define        avioDhubChMap_vpp_HDMI_R_Z1                              0x7
    #define        avioDhubChMap_vpp_AUX_FRC_R_Z1                           0x8
    #define        avioDhubChMap_vpp_AUX_FRC_W_Z1                           0x9
    #define        avioDhubChMap_vpp_TT_R_Z1                                0xA
    #define        avioDhubChMap_vpp_BCM_R_A0                               0x3
    #define        avioDhubChMap_vpp_HDMI_R_A0                              0x4
    #define        avioDhubChMap_vpp_BCM_R_auto                             ((berlin_chip_revision < BERLIN_BG2CDP_A0_EXT) ? 0x6 : 0x3)
    #define        avioDhubChMap_vpp_HDMI_R_auto                            ((berlin_chip_revision < BERLIN_BG2CDP_A0_EXT) ? 0x7 : 0x4)
    #define        avioDhubChMap_ag_APPCMD_R_Z1                             0x0
    #define        avioDhubChMap_ag_MA0_R_Z1                                0x1
    #define        avioDhubChMap_ag_MA1_R_Z1                                0x2
    #define        avioDhubChMap_ag_MA2_R_Z1                                0x3
    #define        avioDhubChMap_ag_MA3_R_Z1                                0x4
    #define        avioDhubChMap_ag_SA_R_Z1                                 0x5
    #define        avioDhubChMap_ag_SPDIF_R_Z1                              0x6
    #define        avioDhubChMap_ag_APPDAT_R_Z1                             0x7
    #define        avioDhubChMap_ag_APPDAT_W_Z1                             0x8
    #define        avioDhubChMap_ag_CSR_R_Z1                                0x9
    #define        avioDhubChMap_ag_GFX_R_Z1                                0xA
    #define        avioDhubChMap_ag_MA0_R_A0                                0x0
    #define        avioDhubChMap_ag_MA1_R_A0                                0x1
    #define        avioDhubChMap_ag_MA2_R_A0                                0x2
    #define        avioDhubChMap_ag_MA3_R_A0                                0x3
    #define        avioDhubChMap_ag_SA0_R_A0                                0x4
    #define        avioDhubChMap_ag_MIC0_W_A0                               0x5
    #define        avioDhubChMap_ag_MIC1_W_A0                               0x6
    #define        avioDhubChMap_ag_CSR_R_A0                                0x7
    #define        avioDhubChMap_ag_GFX_R_A0                                0x8
    #define        avioDhubChMap_ag_MA0_R_auto                              ((berlin_chip_revision < BERLIN_BG2CDP_A0_EXT) ? 0x1 : 0x0)
    #define        avioDhubChMap_ag_MA1_R_auto                              ((berlin_chip_revision < BERLIN_BG2CDP_A0_EXT) ? 0x2 : 0x1)
    #define        avioDhubChMap_ag_MA2_R_auto                              ((berlin_chip_revision < BERLIN_BG2CDP_A0_EXT) ? 0x3 : 0x2)
    #define        avioDhubChMap_ag_MA3_R_auto                              ((berlin_chip_revision < BERLIN_BG2CDP_A0_EXT) ? 0x4 : 0x3)
    #define        avioDhubChMap_ag_CSR_R_auto                              ((berlin_chip_revision < BERLIN_BG2CDP_A0_EXT) ? 0x9 : 0x7)
    #define        avioDhubChMap_ag_GFX_R_auto                              ((berlin_chip_revision < BERLIN_BG2CDP_A0_EXT) ? 0xA : 0x8)
    ...
    #define        avioDhubSemMap_vpp_bcmInvalidReqIntr                     0x1D
    ...
    #define        avioDhubSemMap_ag_audio_intr_A0                          0x1C
