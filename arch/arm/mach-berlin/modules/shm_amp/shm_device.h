...
uint shm_device_allocate(shm_device_t *device, size_t size, size_t align, int mem_type);
...
int shm_device_get_node_info(shm_device_t *device, shm_driver_operation_t *op);
...
int shm_device_add_reference_count(shm_device_t *device, size_t offset);

int shm_device_check_test(shm_device_t *device, shm_check_test_t *op);
