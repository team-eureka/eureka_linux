...
#define avioDhub_h (){}
    ...
    #define        avioDhubChMap_vpp_AUX_FRC_R                              0x8
    #define        avioDhubChMap_vpp_AUX_FRC_W                              0x9
    #define        avioDhubChMap_vpp_TT_R                                   0xA
    ...
    #define        avioDhubChMap_ag_APPDAT_R                                0x7
    #define        avioDhubChMap_ag_APPDAT_W                                0x8
    #define        avioDhubChMap_ag_CSR_R                                   0x9
    #define        avioDhubChMap_ag_GFX_R                                   0xA
